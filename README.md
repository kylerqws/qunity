...
- Round Levels - включить/выключить описания для "круглых" уровней;
- Color - цвет уровня;
- Style - стиль уровня;
- Width - ширина линии уровня;
- Half Levels - включить/выключить описания для "дробно-половинных" уровней;
- Color - цвет уровня;
- Style - стиль уровня;
- Width - ширина линии уровня;
- Float Levels - включить/выключить описания для "дробных" уровней;
- Color - цвет уровня;
- Style - стиль уровня;
- Width - ширина линии уровня;
- Logging - тип логирования в журнале.
